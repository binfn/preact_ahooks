import { useMemo, useState } from '../deps.ts';
...
import { getClientHeight, getScrollHeight, getScrollTop } from '../utils/rect.ts';
import type { Data, InfiniteScrollOptions, Service } from './types.ts';
